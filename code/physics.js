...
function OnContactDetected (contact)
{
	...
	if(a != null && b != null &&
		...
		typeof(b.type) !== 'undefined')
		{
			...
			let limitHorizontal = null;
			if(a.type === "limitHorizontal")
				limitHorizontal = a;
			if(b.type === "limitHorizontal")
				limitHorizontal = b;

			if(pipe != null && limitHorizontal != null)
			{
				score += 5;
				pipe.DeleteObject();
			}

			if(player != null && pipe != null && actualScene.deathPlayer!= null)
			{
				ClearWorld();
				actualScene.game_music.pause();
